...
public class UnitTestColorHash {
    ...
    public void testQuadraticProbing() throws Exception {
    	...
    	assertEquals(v, 6L);
    	System.out.println(testHT.getTableSize());
    }
	@Test
	public void testQuadraticProbingAndResizing() throws Exception {
    	...
    	v = testHT.getValueAt(7);
		    assertEquals(v, 0); // This fails if you rehash too soon. 	   
		}
    	...
    	try {
    	v = testHT.getValueAt(7);
    	assertEquals(v, 0); // Again, this fails if you rehash too soon. 
    	}
    	catch(RuntimeException e) {}
	...
	public void testResponseItemsForQuadraticProbingAndResizing() throws Exception {
    	...
    	System.out.println(ri.nCollisions);
